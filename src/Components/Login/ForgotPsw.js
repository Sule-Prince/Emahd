...
export default () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Forgot | Emahd</title>
        <meta
          name="description"
          content="Forgot your password? Recover it here by providing us basic information."
        />
      </Helmet>
...
const TransitionModal = ({ open, classes, setOpen, feedback }) => {
  const handleClose = () => {
    setOpen(false);
  };
